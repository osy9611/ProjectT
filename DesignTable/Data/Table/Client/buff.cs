...
namespace DesignTable
{
    ...
    public class buffInfo
    {
        ...
        public buffInfo(int buff_Id, sbyte buff_type, float buff_duration, float buff_interval, float buff_usePercent, float buff_arg1, float buff_arg2, float buff_arg3, string buff_arg4)
        {
